...
path = "C:/Users/sur216/Desktop/GISpython data/FLIGHTS/Domestic_monthly/edited_edges/anim"
os.chdir(path)
imaheID = os.listdir(path)
image_names = []
...
for i in image_names:
        count = count+1
        basewidth = 1000
        im = Image.open(image_names[count-1])
...
writeGif('2015-2015.gif',images, duration=0.1, dither=1)
